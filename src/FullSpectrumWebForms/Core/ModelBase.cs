...
namespace FSW.Core
{
    public sealed class ModelBase<T> : LayoutComponentBase where T : FSWPage, new()
    {
        ...
        protected override Task OnInitializedAsync()
        {
            ...
            T page;
            var res = FSW.ModelBase.RegisterFSWPage(page = new T(), null, null, out string newFSWSessionId, out string newFSWSessionAuth);
